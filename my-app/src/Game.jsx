    ...
    return(
        <>
          <li className='game' key={id}>
            ...
            <p>{info}</p>
            <div className='allowed-players-duration'>
            ...
            <div className='age-difficulty-level'>
            ...
            {isEditing && <CreateEditForm game={game} isEditing={isEditing}/>}
          </li>
        </>
    )
}
